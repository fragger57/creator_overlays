...
public class RootGUI extends LightweightGuiDescription {
    ...
    private static final Identifier GR = new Identifier(creatoroverlays.MOD_ID,"textures/icons/gr_tab.png");
    ...
    public RootGUI() {
        ...
        root.add(grGUI.grPanel, builder -> {
            builder.icon(new TextureIcon(GR));
            builder.tooltip(Text.literal("Golden Ratio"));
        });
